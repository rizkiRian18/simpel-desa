...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light p-6 ">
      <div class="container">
       

        <a class="navbar-brand" href="#">
          <img src="{{asset('logo_gambar.svg')}}" width="50" height="44" class="d-inline-block align-top mt-1" alt="">
          ...
          <ul class="navbar-nav ms-auto text-center">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="/rt/">RT</a></li>
                <li><a class="dropdown-item" href="/rw/">RW</a></li>
